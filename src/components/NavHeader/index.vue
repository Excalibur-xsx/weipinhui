    ...
    <header class="common-header" ref="height">
        ...
        <div class="header-inner">
          <div class="address-container">
            ...
            <div class="address-content">
              <!-- <p class="area-explain">请选择你所在的收获地区</p> -->
              <div class="area-tab">
          ...
          <ul class="nav-tool">
              ...
              <ul class="nav-logRes">
                <li class="user-login">
                  ...
                  <div class="user-info">
                    <i class="bottom"></i>
                    <div class="avaterCon">
                      <div class="avaterAside">
                        <span class="avater"></span>
                        <div class="welcome">
                          <p><a>欢迎回来[请登录]</a></p>
                          <p><a @click="logoutClick">退出</a></p>
                        </div>
                      </div>
                    </div>
            ...
            <li class="nav-log nav-good">
              ...
              <!-- <div class="picture">
                <h2>请签到<span class="app">唯品会APP首页</span>签到哦</h2>
                <div class="ariveral">
                ...
                <div>
                  ...
                  <span>也可以使用<strong>微信</strong>扫码签到哦</span>
                </div>
              </div> -->
            </li>
            <li class="nav-log">
      ...
      <div class="head-logo">
        <div class="head-inner">
          <div class="logo">
            <router-link class="logo" title="唯品会" to="/">
          ...
          <div class="service">
            ...
            <a class="service-link" href=""></a>
            <a class="service-link" href=""></a>
            <img src="../NavHeader/images/service.jpg" alt="" />
          </div>
          <div class="search">
  ...
  .head-logo {
    ...
    .head-inner {
      ...
      .service {
        ...
        //   width: 101px;
        //   height: 100px;
        //   background: url("./images/sprites.png") repeat 0 0;
        // }
        img {
          border: 0 none;
          vertical-align: top;
